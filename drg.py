...
op=preditction_with_beam_search("<POS> <CON_START> The weather is awesome. <START>",4)
...
path = os.path.join(os.getcwd(), "/home/ec2-user/SageMaker/model1.bin")
...
string="<POS><CON_START>"+string+'.<START>'
